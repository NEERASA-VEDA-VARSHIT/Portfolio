...
function App() {
  ...
  const fullText = "func App() { return <div>Hello, World!</div>; }";
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-[#fff8f0]">
      ...
      <div className="flex items-center space-x-3 left-18 top-2 z-50 absolute">
        ...
        />
        {/* <div>
              <h1 className="text-xl font-bold text-gray-800">Emma</h1>
              <p className="text-xs text-gray-500 tracking-wider">VISUAL ART</p>
            </div> */}
      </div>
      ...
      <div className="fixed left-23 top-4/6 transform -translate-y-1/2 z-20 opacity-60">
        <div className="flex flex-col items-center space-y-6">
          ...
          >
            <svg
              className="w-5 h-5 fill-gray-600 group-hover:fill-gray-900 transition-colors duration-300"
              viewBox="0 0 24 24"
            >
      ...
      {/* Gradient Circle
      <div
        className="absolute bottom-40 left-1/3 transform -translate-x-1/2 w-32 h-32 rounded-full"
        style={{
          background: `
            radial-gradient(circle at 30% 30%, #00c896 0%, #00754b 50%, #474747 100%),
            linear-gradient(135deg, #00c896 0%, #00754b 40%, #474747 100%)
          `,
          filter: "blur(0.5px)",
          opacity: 0.8,
      ...
      {/* Rectangle with Top Rounded - Orange/Purple Theme */}
      {/* <div
      ...
      >
        ...
        <img
          ...
          alt="Description"
          className="absolute top-[-200px] left-1/2 transform -translate-x-1/2 scale-120 w-100 h-155 object-cover"
        />
      </div> */}
    ...
    src={pic}
    alt="Description"
    className="absolute top-[-200px] left-1/2 transform -translate-x-1/2 scale-120 w-100 h-160 object-cover"
  /> */}
      ...
      <svg
        ...
        height="600"
        viewBox="0 0 400 600"
        className="absolute top-[50px] left-[150px] z-50"
      >
        <path
          id="loopArrowPath"
          d="M 250,480 
        ...
        <text fontSize="12" fill="#f5d76e" fontFamily="sans-serif">
          <textPath
            href="#loopArrowPath"
            startOffset="85%"
